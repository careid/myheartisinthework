...
namespace HeartGame
{
    ...
    public class Drawer2D
    {
        ...
        public static void DrawStrokedText(SpriteBatch batch, string toDisplay, SpriteFont Font, Vector2 textPosition, Color textColor, Color strokeColor)
        {
            if (toDisplay == null)
                toDisplay = "null";
            batch.DrawString(Font, toDisplay, textPosition - new Vector2(1, 0), strokeColor);
            batch.DrawString(Font, toDisplay, textPosition + new Vector2(1, 0), strokeColor);
            batch.DrawString(Font, toDisplay, textPosition + new Vector2(0, 1), strokeColor);
            batch.DrawString(Font, toDisplay, textPosition - new Vector2(0, 1), strokeColor);
            batch.DrawString(Font, toDisplay, textPosition, textColor);
