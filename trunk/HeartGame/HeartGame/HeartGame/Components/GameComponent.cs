...
namespace HeartGame
{
    public class GameComponent
    {
        ...
        public virtual void Render(GameTime gameTime, Camera camera, SpriteBatch spriteBatch, GraphicsDevice graphicsDevice, Effect effect)
        {
        ...
        public void RemoveChild(GameComponent child)
        {
            if (HasChildWithGlobalID(child.GlobalID))
            {
                ...
                while (!Children.TryRemove(child.LocalID, out removed)) { }
            }
        }
        ...
        public List<T> GetChildrendOfTypeRecursive<T>() where T : GameComponent
        {
            ...
            foreach (GameComponent child in Children.Values)
            {
                ...
                toReturn.AddRange(child.GetChildrendOfType<T>());
            }
